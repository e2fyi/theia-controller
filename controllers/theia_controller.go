...
// +kubebuilder:rbac:groups=e2.fyi.e2.fyi,resources=theia,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=e2.fyi.e2.fyi,resources=theia/status,verbs=get;update;patch
